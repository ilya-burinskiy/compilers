...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LPARENT = 6,                    /* LPARENT  */
  YYSYMBOL_RPARENT = 7,                    /* RPARENT  */
  YYSYMBOL_COMMA = 8,                      /* COMMA  */
  YYSYMBOL_ASSIGN = 9,                     /* ASSIGN  */
  YYSYMBOL_LOR = 10,                       /* LOR  */
  YYSYMBOL_LAND = 11,                      /* LAND  */
  YYSYMBOL_LXOR = 12,                      /* LXOR  */
  YYSYMBOL_LNOT = 13,                      /* LNOT  */
  ...
  YYSYMBOL_optparams = 22,                 /* optparams  */
...
static const char *const yytname[] =
{
  ...
  "IDENTIFIER", "LPARENT", "RPARENT", "COMMA", "ASSIGN", "LOR", "LAND",
  "LXOR", "LNOT", "ERROR", "NEW_LINE", "$accept", "prog", "stmt", "assign",
  "expr", "call", "optparams", "params", "param", YY_NULLPTR
};
...
{
       6,    14,    13,    15,     0,     0,    16,     0,     2,     4,
       5,    12,    20,     0,    15,     0,    11,     1,     6,     0,
       0,     0,    23,     0,    19,    22,     7,    17,     3,     8,
      10,     9,    18,     0,    21
};
...
{
      15,    16,     1,     2,     3,     4,    17,    12,    22,    26,
      13,    12,     5,     6,    32,    29,    30,    31,    18,    33,
       1,     2,    14,     4,    19,    20,    21,    20,    28,    22,
       5,     6,    27,    34,     0,    19,    20,    21
};

static const yytype_int8 yycheck[] =
{
       4,     5,     3,     4,     5,     6,     0,     6,    12,    13,
       9,     6,    13,    14,     7,    19,    20,    21,    15,     8,
       3,     4,     5,     6,    10,    11,    12,    11,    18,    33,
      13,    14,     7,    33,    -1,    10,    11,    12
};
...
{
       0,     3,     4,     5,     6,    13,    14,    17,    18,    19,
      20,    21,     6,     9,     5,    20,    20,     0,    15,    10,
      11,    12,    20,    22,    23,    24,    20,     7,    18,    20,
      20,    20,     7,     8,    24
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, Statement ** root)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (root);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, Statement ** root)
{
  YY_USE (yyvaluep);
  YY_USE (root);
  if (!yymsg)
...
#line 51 "src/parser.y"
                          { (yyval.stmt) = construct_compound_stmt((yyvsp[-2].stmt), (yyvsp[0].stmt)); }
#line 1112 "src/parser.c"
    break;
...
#line 53 "src/parser.y"
            { (yyval.stmt) = construct_expression_stmt((yyvsp[0].expr)); }
...
#line 69 "src/parser.y"
                                            { (yyval.expr) = construct_call_expr((yyvsp[-3].id), (yyvsp[-1].param)); }
